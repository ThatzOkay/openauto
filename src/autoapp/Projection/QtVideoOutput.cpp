        ...
        namespace autoapp
        {
            namespace projection
            {
                ...
                QtVideoOutput::QtVideoOutput(configuration::IConfiguration::Pointer configuration, QWidget *videoFrame)
                    : VideoOutput(std::move(configuration)), playerReady_(false), initialBufferingDone_(false), bytesWritten_(0), videoFrame_(videoFrame)
                {
                ...
                void QtVideoOutput::onStartPlayback()
                {
                    ...
                    if (videoFrame_)
                    {
                        videoWidget_->resize(videoFrame_->size());
